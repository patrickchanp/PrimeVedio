...
class PageViewListModel extends Object {
  ...
  factory PageViewListModel.fromJson(Map<String, dynamic> srcJson) =>
      _$PageViewListModelFromJson(srcJson);

  Map<String, dynamic> toJson() => _$PageViewListModelToJson(this);
}

@JsonSerializable()
class PageList extends Object {
  @JsonKey(name: 'vod_id')
  int vodId;
  ...
  factory PageList.fromJson(Map<String, dynamic> srcJson) =>
      _$PageListFromJson(srcJson);
